...
@app.command(name="linkedin-apply")
def linkedin_apply(
    ...
    from applypilot.config import check_tier
    from applypilot.apply.launcher import run_linkedin_apply
    from applypilot.linkedin.search import get_linkedin_jobs

    # Check Tier 3 required (Claude Code CLI + Chrome)
    check_tier(3, "linkedin-apply")
    ...
    console.print("\n[bold blue]LinkedIn Easy Apply[/bold blue]")
